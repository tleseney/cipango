...
@SipServlet(name="org.cipango.tests.authentication.AuthenticationTest")
public class AuthenticationServlet extends SipServletTestCase
{
	public void doRequest(SipServletRequest request) throws ServletException, IOException
	{
		...
		else if (!"ACK".equals(method))
		{
			...
			response.addHeader("Servlet", "AuthenticationServlet");
			response.send();
		}
	}
}
